"""ASHRAE Linear Regression Benchmark with Building Selection - Fixed Version"""
...
def main():
    ...
    training_info = {
        ...
        'n_test_samples': len(y_true_original),
...
if __name__ == "__main__":
    success = main()
    if success:
        print("\n🎉 ASHRAE Linear Regression benchmark with building selection completed successfully!")
    else:
        print("\n💥 ASHRAE Linear Regression benchmark with building selection failed!")
        sys.exit(1)
