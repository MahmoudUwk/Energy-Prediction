...
def get_LSTM_model(units,input_dim,output_dim,num_layers,name='MLP'):
...
alg_name = 'MLP'
data_types = ['5T']
seq_all = [1,2,4,5,6,12,18]#[5,20]
num_units = [15,30,50]#[35]#[8,10,15]
num_layers_all = [2]
epochs_num = 2000
...
# print(df['RMSE'].min())
print(df.sort_values(by=['RMSE']).iloc[0,:])
# RMSE_all = df.groupby(by='Algorithm').min()['RMSE']
# print(RMSE_all)
# l_u = []
