...
from niapy.algorithms.modified import HybridBatAlgorithm,Mod_FireflyAlgorithm
...
# algorithm = FireflyAlgorithm(population_size=40)
# algorithm = Mod_FireflyAlgorithm.Mod_FireflyAlgorithm(population_size=40)



best_params, best_accuracy = algorithm.run(task)
task.plot_convergence(x_axis='evals')
# print(task.convergence_data())
...
print(task.convergence_data(x_axis='evals'))
